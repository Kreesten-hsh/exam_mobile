...
class _$UserDtoImpl extends _UserDto {
  ...
  @override
  String toString() {
    return 'UserDto(id: $id, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, birthDate: $birthDate, profilePhotoUrl: $profilePhotoUrl, role: $role, token: $token)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, email, firstName, lastName,
      gender, birthDate, profilePhotoUrl, role, token);
...
abstract class _UserDto extends UserDto {
  const factory _UserDto(
      ...
      final String? token}) = _$UserDtoImpl;
